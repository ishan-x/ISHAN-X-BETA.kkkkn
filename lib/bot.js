...
OWNER_IMG: process.env.OWNER_IMG || "https://files.catbox.moe/ohup36.png",
CONVERT_IMG: process.env.CONVERT_IMG || "https://n.uguu.se/BlGoHUJU.jpg",
AI_IMG: process.env.AI_IMG || "https://files.catbox.moe/h1xuqv.jpg",
SEARCH_IMG: process.env.SEARCH_IMG || "https://files.catbox.moe/h1xuqv.jpg",
DOWNLOAD_IMG: process.env.DOWNLOAD_IMG || "https://files.catbox.moe/h1xuqv.jpg",
MAIN_IMG: process.env.MAIN_IMG || "https://i.ibb.co/s9Cr1VSX/file-000000006d207207b33a182396f1a27f.png",
GROUP_IMG: process.env.GROUP_IMG || "https://files.catbox.moe/h1xuqv.jpg",
FUN_IMG: process.env.FUN_IMG || "https://files.catbox.moe/h1xuqv.jpg",
TOOLS_IMG: process.env.TOOLS_IMG || "https://files.catbox.moe/h1xuqv.jpg",
OTHER_IMG: process.env.OTHER_IMG || "https://files.catbox.moe/h1xuqv.jpg",
MOVIE_IMG: process.env.MOVIE_IMG || "https://files.catbox.moe/h1xuqv.jpg",
NEWS_IMG: process.env.NEWS_IMG || "https://files.catbox.moe/h1xuqv.jpg",
PP_IMG: process.env.PP_IMG || "https://files.catbox.moe/h1xuqv.jpg"
};
